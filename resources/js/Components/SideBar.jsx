...
export default function SideBar({}) {
    return (
        ...
        <div className="">
            {/* Content */}
            <div className="text-black dark:text-white p-4 sm:bg-blue-700 sm:dark:bg-black rounded-l-lg space-y-4">
                {/* Logo Area */}
                ...
                <div className="flex flex-col gap-y-6 mb-6">
                    ...
                    <div className="flex flex-col gap-y-2">
                        <h6>Your teams</h6>
                        <SideBarButton>
                            <div className="px-2 py-1 border border-slate-400 bg-slate-300 bg-transparent rounded text-xs bg-opacity-30">
                                H
                            </div>
